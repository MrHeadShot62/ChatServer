...
//        System.out.printf("[DEBUG]              Login: %s%n",authPacket.getLogin());
        System.out.printf("[DEBUG]               Pass: %s%n",authPacket.getType());
...
//            PacketManager.packetGenerator(new ServerAnswerAuthUserPacket(session, ServerStorage.getInstance().getUser(id), AuthType.), id);
//        }else{
